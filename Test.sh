...
# create partitions
sgdisk -n 1::+1M --typecode=1:ef02 -c 1:'BIOSBOOT' ${DISK} # partition 1 (BIOS Boot Partition)
sgdisk -n 2::+300M --typecode=2:ef00 -c 2:'EFIBOOT' ${DISK} # partition 2 (UEFI Boot Partition)
sgdisk -n 3::-0 --typecode=3:8300 -c 3:'ROOT' ${DISK} # partition 3 (Root), default start, remaining
